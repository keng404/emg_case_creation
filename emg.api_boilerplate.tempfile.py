...
def main():
	...
	print(route_login_platform)
	bearer_token = f'{token_type.capitalize()} {access_token}'
	print(bearer_token)


	csv_file = args.csv_file
	csv_lines = parse_csv(csv_file)
	
	with NamedTemporaryFile(mode="w", delete=False) as temp_file:
		for csv_line in csv_lines:
			temp_file.write(f"{csv_line}\n")
		temp_file.flush()	
		batch_creation_string = f"node batchCasesCreator.js create -h https://{hostname}.emg.illumina.com -c {temp_file.name}"
